...
namespace PMSoft.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        public static bool IsAssignableToGenericType(this Type givenType, Type genericType)
        {
            ...
            if (givenType.IsGenericType && givenType.GetGenericTypeDefinition().Equals(genericType))
            {
                return true;
            }

            if (givenType != null && givenType.IsGenericType && (givenType.IsAssignableFrom(genericType)))
            {
                return true;
            }
            if (givenType != null && givenType.IsGenericType && (givenType.GetGenericTypeDefinition().FullName.Equals(genericType.FullName)))
            {
                return true;
            }
        ...
        {
            if (type != null && type.Name.StartsWith("WF_"))
            {
                return true;
            }
            return false;
